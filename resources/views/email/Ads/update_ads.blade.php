...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="details">
                <table>
                    ...
                    <tr>
                        <th>Status</th>
                        <td>
                            <span class="badge badge-{{ $ads->status }}">
                                {{ ucfirst($ads->status) }}
                            </span>
                        </td>
                    </tr>
                    <tr>
                        <th>Category</th>
                        <td>{{ optional($ads->category)->name }}</td>
                    </tr>
                    <tr>
                        <th>User</th>
                        <td>{{ optional($ads->user)->name }}</td>
                    </tr>
                    <tr>
                        <th>Updated At</th>
                        <td>{{ $ads->updated_at->format('Y-m-d H:i') }}</td>
                    </tr>
                </table>
            </div>
            ...
            <p style="margin-top: 30px;">Thank you for staying with us.</p>
        </div>
